...
<section class="header_text sub">
  <img class="contact" src="/static/css/themes/images/contact.png" alt="Contact" width="20%">
</section>
  ...
  <div class="row">       
    <div class="span5">
      <div>
        ...
        <p><strong>Phone:</strong>&nbsp;0163 6556 937<br>
        <strong>Fax:</strong>&nbsp;+04 (123) 456-7890<br>
        <strong>Email:</strong>&nbsp;<a href="https://mail.google.com">vien.dinh@gmail.com</a>               
        </p>
        <br/>
