...
// Id doesn't exist
func GetImagesById(id int64) (v *Images, err error) {
	o := orm.NewOrm()
	v = &Images{Id: id}
	if err = o.QueryTable(new(Images)).Filter("Id", id).RelatedSel().One(v); err == nil {
		return v, nil
	}
	return nil, err
}
...
func DeleteImages(id int64) (err error) {
	o := orm.NewOrm()
	v := Images{Id: id}
	// ascertain id exists in the database
	if err = o.Read(&v); err == nil {
