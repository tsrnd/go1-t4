...
func (m *MockBookUsecase) GetByName(name string) ([]*book.Book, error) {
...
func (mr *MockBookUsecaseMockRecorder) GetByName(name interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetByName", reflect.TypeOf((*MockBookUsecase)(nil).GetByName), name)
}

// Create mocks base method
func (m *MockBookUsecase) Create(name, content string, userID int64) (*book.Book, error) {
...
func (mr *MockBookUsecaseMockRecorder) Create(name, content, userID interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockBookUsecase)(nil).Create), name, content, userID)
}
